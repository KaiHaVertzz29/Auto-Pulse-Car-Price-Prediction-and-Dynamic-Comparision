...
def home_page():
    ...
    car_data=pd.read_csv('https://raw.githubusercontent.com/KaiHaVertzz29/Auto-Pulse-Car-Price-Prediction-and-Dynamic-Comparision/main/car_data.csv')

    by_brand=pd.read_csv('https://raw.githubusercontent.com/KaiHaVertzz29/Auto-Pulse-Car-Price-Prediction-and-Dynamic-Comparision/main/by_brand.csv')

    logo_links=pd.read_csv('https://raw.githubusercontent.com/KaiHaVertzz29/Auto-Pulse-Car-Price-Prediction-and-Dynamic-Comparision/main/car_logos.csv')
